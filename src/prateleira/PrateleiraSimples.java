...
public class PrateleiraSimples extends ElementoGraficoDefault {
    ...
    public PrateleiraSimples(Point pos, ComponenteVisual imagem, int capacidade, int base, int largProd, int altProd) {
        super(pos, imagem);
    ...
    public boolean receberProduto(Produto p, Point pos) {
        if (!podeReceber(p))
            return false;
        // ver onde clicou
